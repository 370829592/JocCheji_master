...
public class ActionBar extends RelativeLayout implements OnClickListener {
	...
	public ActionBar(Context context, AttributeSet attrs) {
		...
		addView(mBarView, params);
		// addView(mBarView);

		// mLogoView = (ImageView)
		// mBarView.findViewById(R.id.actionbar_home_logo);
		// mHomeLayout = (RelativeLayout) mBarView
		// .findViewById(R.id.actionbar_home_bg);
		// mHomeBtn = (ImageButton)
		// mBarView.findViewById(R.id.actionbar_home_btn);
		...
		mBtnBack = (Button) mBarView.findViewById(R.id.actionbar_btn_back);
		mBtnRight = (Button) mBarView.findViewById(R.id.actionbar_btn_right);

		// mSnsShare = (Button) mBarView.findViewById(R.id.actionbar_snsshare);
		//
		// mSnsShare.setOnClickListener(new OnClickListener() {
		// public void onClick(View v) {
		//
		// // mProgress.setVisibility(View.VISIBLE);
		// ActionBarHelper.startProgress();
		// Bitmap bmp = getRootViewSnapshot();
		...
		// }
		//
		// UMSnsService.share(mContext, picture, "", null);
		//
		// }
		// });
	...
	public Bitmap getRootViewSnapshot() {
		...
		{
			result = Bitmap.createBitmap(mRootView.getDrawingCache());
		}
	...
	// * toggles whether the "home" view should have a little triangle
	// indicating
	// * "up"
	// */
