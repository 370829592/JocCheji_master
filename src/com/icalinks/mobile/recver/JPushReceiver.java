...
import com.icalinks.mobile.ui.FbStartActivity;
...
public class JPushReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			if (pushMsg != null) {
				if (pushMsg.toUpperCase().equals(HomeActivity.JP_UPGRADE)) {
			...
			// 打开自定义的Activity
			Intent i = new Intent(context, FbStartActivity.class);// test
