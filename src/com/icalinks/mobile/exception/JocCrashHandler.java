...
public class JocCrashHandler implements UncaughtExceptionHandler {

	private static final String TAG = JocCrashHandler.class.getSimpleName();
	...
	/** CrashHandler实例 */
	private static JocCrashHandler INSTANCE;
	/** 程序的Context对象 */
	...
	private JocCrashHandler() {

	}

	public static JocCrashHandler getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new JocCrashHandler();
		}
